...
SELECT dvdNUM, data_locacao, data_devolucao, valor, CAST(valor + 2) as valorM FROM Locacao
...
SELECT num_cadastro, nome, logradouro + ' '+ num + ' '+cep AS end_comp FROM Cliente
WHERE num_cadastro >= 5503